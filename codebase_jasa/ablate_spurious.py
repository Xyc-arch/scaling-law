...
def run_experiment(parent_path, seed_size, classifier_type, spurious_column, spurious_small_is_0, target_column, add_data, metric):
    """
    Run the fixed-seed-size spurious-correlation ablation experiment.

    Parameters
    ----------
    parent_path : str
        Directory containing seed, training, synthetic, and test CSV files.
    seed_size : int
    ...
    add_data : str
        Name of the synthetic or baseline augmentation method used to locate input files.
    metric : str
    ...
    dict
        ...
        and the balanced-with-synthetic-data condition.
    """
