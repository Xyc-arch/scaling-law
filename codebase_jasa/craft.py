...
def generate_causal_dataset_rounded(n_samples, noise_level=1):
    """
    Generate a synthetic causal dataset with rounded features and a binary target.
    ...
    noise_level : float, optional
        Standard deviation of the Gaussian noise added to the target-generating linear combination.
        Default is 1.

    Returns
    -------
    pandas.DataFrame
        Dataframe containing features X1 through X9 and the binary target column Target.
    """
